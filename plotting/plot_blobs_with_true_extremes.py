...
"""
This scripts plots reconstructed hits and the blobs centred in the
reconstructed end-points of the track (in green). The true end-point
of the primary electron (for single e-) or of
